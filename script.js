...
async function loadInitialRecommendations() {
  const movies = ['Dark', 'From', 'Incantation', 'Alice in Borderland', 'The Prestige', 'Oldboy', 'Squid Game' ,'Forrest Gump' ,'Parasite' ,' 500 days of summer']; // List of movies to load initially
